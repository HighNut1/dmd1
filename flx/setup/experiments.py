...
EXTRACTORS = {
    ...
    for loader in [
        ...
        FixedLengthExtractorLoader(
            ...
            lambda: get_DeepPrint_Tex(2000, 32),
        ),
        FixedLengthExtractorLoader(
            "DeepPrint_Tex_64",
            "DeepPrint (texture branch, 64 dims)",
            lambda: get_DeepPrint_Tex(2000, 64),
        ),
        FixedLengthExtractorLoader(
            "DeepPrint_Tex_128",
            "DeepPrint (texture branch, 128 dims)",
            lambda: get_DeepPrint_Tex(2000, 128),
        ),
        FixedLengthExtractorLoader(
            "DeepPrint_Tex_256",
            "DeepPrint (texture branch, 256 dims)",
            lambda: get_DeepPrint_Tex(2000, 256),
        ),
        FixedLengthExtractorLoader(
            "DeepPrint_Tex_512",
            "DeepPrint (texture branch, 512 dims)",
            lambda: get_DeepPrint_Tex(2000, 512),
        ),
        FixedLengthExtractorLoader(
            "DeepPrint_Tex_1024",
            "DeepPrint (texture branch, 1024 dims)",
            lambda: get_DeepPrint_Tex(2000, 1024),
        ),
        FixedLengthExtractorLoader(
            "DeepPrint_Tex_2048",
            "DeepPrint (texture branch, 2048 dims)",
            lambda: get_DeepPrint_Tex(2000, 2048),
        ),
        # Different variants
        FixedLengthExtractorLoader(
            "DeepPrint_Minu_512",
            "DeepPrint (minutia branch, 512 dims)",
            lambda: get_DeepPrint_Minu(2000, 512),
        ),
        FixedLengthExtractorLoader(
